package com.developer.calllogmanager.voiceupdate;
...
import com.developer.calllogmanager.MainActivity;
...
public class EditNoteActivity extends AppCompatActivity {
    ...
    String filePath;
    String voicePresent;
    Button btnAddVoice,btnSaveNote,btnSaveStatus;
    ...
    private void getTextData() {
        ...
        if (fetch!=null) {
            ...
            tvCurrentDate.setText(fetch.getCurrentDate());
            tvCurrentTime.setText(fetch.getCurrentTime());
